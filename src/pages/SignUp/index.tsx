            ...
            <DivForm>
                <Infos onSubmit={(event)=>onFinish(event)}>
                        ...
                        <DivInput>
                            ...
                            <Input placeholder= "Nome" type="name" invalid={invalid}/>
                            <Input placeholder= "Sobrenome" type="name" invalid={invalid}/>
                            <Input placeholder= "Email" type="name" invalid={invalid}/>
                            <Input placeholder= "Senha" type="password" invalid={invalid}/>
                            <Input placeholder= "Repetir senha" type="password" invalid={invalid}/>
                        </DivInput>  
